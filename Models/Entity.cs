...
public class Entity
{
   ...
   [Required][StringLength(50)]public required string Position { get; set; }
...
//navigation property used to store multvalued properties
    ...
    // public ICollection<AttributeEntry> Experience { get; set; } = new List<AttributeEntry>();
    // public ICollection<AttributeEntry> Education  { get; set; } = new List<AttributeEntry>();
    // public ICollection<AttributeEntry> Acheivements { get; set; } = new List<AttributeEntry>();
